package com.shenshanlaoyuan.smartcity.newstpipage;
...
import com.shenshanlaoyuan.smartcity.domain.TPINewsData;
import com.shenshanlaoyuan.smartcity.domain.TPINewsData.TPINewsData_Data.TPINewsData_Data_LunBoData;
...
public class TPINewsNewsCenterPager {
	...
	private void initData() {
		...
		if (!TextUtils.isEmpty(jsonCache)) {
			// 有数据，解析数据
			com.shenshanlaoyuan.smartcity.domain.TPINewsData newsData = parseJson(jsonCache);
			// 处理数据
	 ...
	 * @param newsData
	 */
	private void processData(com.shenshanlaoyuan.smartcity.domain.TPINewsData newsData) {
		// 完成数据的处理
	...
	private void setLunBoData(com.shenshanlaoyuan.smartcity.domain.TPINewsData newsData) {
		// 获取轮播图的数据
		...
		httpUtils.send(HttpMethod.GET, MyConstants.SERVERURL + viewTagData.url,
				new RequestCallBack<String>() {
					...
					public void onSuccess(ResponseInfo<String> responseInfo) {
						...
						// 解析数据
						com.shenshanlaoyuan.smartcity.domain.TPINewsData newsData = parseJson(jsonData);
